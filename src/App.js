    ...
    return (
        ...
        <div className="App">
          <ol style={{ textAlign: "left" }}>
            <li>
              y Add Routes to load "Users" and "Courses" on different pages (by
              entering a URL, without Links)
            </li>
            <li>
              y Add a simple navigation with two links => One leading to
            ...
            <li>
              y Make the courses in "Courses" clickable by adding a link and
              load the "Course" component in the place of "Courses" (without
              passing any data for now)
            </li>
            <li>
              y Pass the course ID to the "Course" page and output it there
            </li>
            <li>
            ...
            <li>y Add a 404 error page and render it for any unknown routes</li>
            <li>
              y Redirect requests to /all-courses to /courses (=> Your "Courses"
              page)
            </li>
          </ol>
          <Switch>
